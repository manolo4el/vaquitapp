...
match /databases/{database}/documents {
  ...
  match /invitations/{invitationId} {
    // Leer: cualquier usuario autenticado puede leer invitaciones (para poder unirse)
    allow read: if request.auth != null;
    
    // Crear: cualquier usuario autenticado puede crear invitaciones
    allow create: if request.auth != null;
    
    // Actualizar: cualquier usuario autenticado puede actualizar (para aceptar invitaciones)
    allow update: if request.auth != null;
